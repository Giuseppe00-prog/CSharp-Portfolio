...
{
    /// <inheritdoc />
    public partial class AddOrdersAndCustomers : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrdineProdotto", x => new { x.OrdineId, x.ProdottoId });
                    table.ForeignKey(
                        name: "FK_OrdineProdotto_Ordini_OrdineId",
                        column: x => x.OrdineId,
                        principalTable: "Ordini",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrdineProdotto_Prodotti_ProdottoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrdineProdotto_ProdottoId",
